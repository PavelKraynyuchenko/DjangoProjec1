...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='blog',
            name='posted',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2022, 4, 21, 11, 10, 13, 97124), verbose_name='Опубликована'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=datetime.datetime(2022, 4, 21, 11, 10, 13, 98194), verbose_name='Дата комментария')),
